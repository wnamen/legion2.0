        ...
        { this.props.currentDelay &&
          <div class="sixteen text-center">
            <div class="gray inlineFlex delayAdjuster">
              ...
              <input type="number" min="1" max="30" class="delayPicker inline-block" value={this.state.currentDelay || this.props.currentDelay} id={this.props.data.id} onChange={this.handleDelayChange}/> days, then send the following template
            </div>
          </div>
        }
      </div>
