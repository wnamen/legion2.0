    ...
    return (
        <div class="sixteen modalContainer">
         	<div class="eight columns text-center smallModal">
		        ...
		        <button type="submit" onClick={this.triggerModalClose} class="lgnBtn settingsBtn lgnBtnLg smoothBkgd electric-blue-background white inline-block signupBtn">Map My Contacts</button>
        	</div>
        </div>
    )
  }
